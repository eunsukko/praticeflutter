...
class SizedPaginatedDataTable extends StatefulWidget {
  ...
  @override
  SizedPaginatedDataTableState createState() => SizedPaginatedDataTableState(
...
class SizedPaginatedDataTableState extends State<SizedPaginatedDataTable> {
  int _firstRowIndex;
  int _rowCount;
  ...
  @override
  void didUpdateWidget(SizedPaginatedDataTable oldWidget) {
